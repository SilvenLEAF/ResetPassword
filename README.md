# ResetPASSWORD
I'm learning how Forgotten password and Password Reset flow works, including 2 way authentication (email verification) and email sending from my FrontEND form with my BackEND.
...
## Top features
* **Password Reset**
* **2way authentication (email verification)**
* **Email Seding from FrontEND**
* **OAUTH 2.0**
* **REST API**
* **CRUD**
